<?php /* Smarty version 2.6.26, created on 2020-09-17 19:24:19
         compiled from c1.tpl */ ?>
<!DOCTYPE html>
<html  >
<head>
...
<?php echo $this->_tpl_vars['vv1']['aname']; ?>
                    ...
                    <div class="mbr-section-btn text-center"><a href="blogview.php?k=<?php echo $this->_tpl_vars['vv1']['blogkey']; ?>
...
<?php echo $this->_tpl_vars['vv']['aname']; ?>
                    ...
                    <div class="mbr-section-btn text-center"><a href="blogview.php?k=<?php echo $this->_tpl_vars['vv']['blogkey']; ?>
" class="btn btn-primary-outline display-4">
                            Read More
                        </a></div>
                </div>
