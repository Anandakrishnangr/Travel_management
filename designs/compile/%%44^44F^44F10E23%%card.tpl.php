<?php /* Smarty version 2.6.26, created on 2020-09-23 16:15:22
...
<!-- //for-mobile-apps -->
<link href="web/payment/css/style.css" rel="stylesheet" type="text/css" media="all" />
<link href=\'//fonts.googleapis.com/css?family=Fugaz+One\' rel=\'stylesheet\' type=\'text/css\'>
<link href=\'//fonts.googleapis.com/css?family=Alegreya+Sans:400,100,100italic,300,300italic,400italic,500,500italic,700,700italic,800,800italic,900,900italic\' rel=\'stylesheet\' type=\'text/css\'>
<link href=\'//fonts.googleapis.com/css?family=Open+Sans:400,300,300italic,400italic,600,600italic,700,700italic,800,800italic\' rel=\'stylesheet\' type=\'text/css\'>
<script type="text/javascript" src="web/payment/js/jquery.min.js"></script>
</head>
<body>
	<div class="main">
		<h1>Add Card</h1>
		<div class="content">
			...
			<script src="web/payment/js/easyResponsiveTabs.js" type="text/javascript"></script>
									...
									<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-0">
										<div class="payment-info">
											...
											<form action="" method="POST">
												<div class="tab-for">				
													...
													<input type="hidden" name="hide" value="h">
														<input type="text" value="" name="nameoncard" required>
													<h5>CARD NUMBER</h5>													
												...
												<div class="transaction">
													<div class="tab-form-left user-form">
														<h5>EXPIRATION</h5>
															<ul>
																<li>
																	<input type="number"  name="emonth" class="text_box" type="text" value="6" min="1" required >	
																</li>
																<li>
																	<input type="number" name="eyear" class="text_box" type="text" value="1988" min="1"  required />	
																</li>
											...
											<div class="single-bottom">
													<ul>
														<li>
															<input type="checkbox"  id="brand" value="checked" required>
										...
										<div class="payment-info">
											...
											<form>
												<div class="tab-for">				
													...
													<h5>CARD NUMBER</h5>													
														<input class="pay-logo" type="text" value="0000-0000-0000-0000" onfocus="this.value = \'\';" onblur="if (this.value == \'\') {this.value = \'0000-0000-0000-0000\';}" name="cardno" required="">
												</div>	
												<div class="transaction">
													<div class="tab-form-left user-form">
														<h5>EXPIRATION</h5>
															<ul>
																<li>
																	<input type="number" class="text_box" type="text" value="6" min="1" name="emonth" />	
																</li>
																<li>
																	<input type="number" class="text_box" type="text" value="2020" min="1" name="eyear" />	
																</li>
													...
													<div class="tab-form-right user-form-rt">
														<h5>CVV NUMBER</h5>													
														<input type="text" value="xxxx" onfocus="this.value = \'\';" onblur="if (this.value == \'\') {this.value = \'xxxx\';}" value="cvv" required="">
													</div>
													<div class="clear"></div>
												</div>
												<input type="submit" value="SUBMIT" >
		...
		<p class="footer">Copyright © 2020 Payment . All Rights Reserved </p>
	</div>
</body>
</html>