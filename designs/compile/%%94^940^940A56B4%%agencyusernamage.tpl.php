<?php /* Smarty version 2.6.26, created on 2020-11-12 14:27:12
         compiled from agencyusernamage.tpl */ ?>
<html>
<head>
...
?>
   ...
   <?php if ($this->_tpl_vars['b']['status'] == 2): ?>
			 
    <td>Suspended</td>
    <td style="border-right: hidden;border-top: hidden;border-bottom: hidden;">
    <a  class="button1" style="text-decoration: none;" 	href="adminuserd.php?f=<?php echo $this->_tpl_vars['b']['loginid']; ?>
&&k=1">Activate</a>
    </td>
    <?php else: ?>
	  <td>Active</td>
    <td style="border-right: hidden;border-bottom: hidden;border-top: hidden;">
    <a  class="button2"  style="text-decoration: none;" href="adminuserd.php?f=<?php echo $this->_tpl_vars['b']['loginid']; ?>
&&k=2">Suspend</a></td>
	   <?php endif; ?>
       </tr>
