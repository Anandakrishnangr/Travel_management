<?php /* Smarty version 2.6.26, created on 2020-09-17 19:17:17
         compiled from pc2.tpl */ ?>
<!DOCTYPE html>
<html>
<head>
	<title></title>
      ...
      <div class="container"  >
        <div class="row justify-content-center mb-5">
          <div class="col-md-7 text-center">
            <span class="text-serif text-primary" style="font-size: 30px;">LATEST PACKAGES</span>
...
" alt="Image"   style="height: 220px;width: 100%;min-height: 160px;"   class="img-fluid">
              <div class="p-4" >
                ...
                <small><a onclick="log()" style="text-decoration: none;font-size: 12px;" href="packagedetails.php?k=<?php echo $this->_tpl_vars['v']['pkey']; ?>
...
" data-size="sm" title=""><small style="font-size: 12px;"><i class="fa fa-users" aria-hidden="true"></i>&nbsp;<?php echo $this->_tpl_vars['v']['ratecount']; ?>
 ...
 days
                  ...
                  <div class="ml-auto price">
                    <span class="bg-primary"><a onclick="log()" style="text-decoration: none;color: white;font-size: 12px;" href="packagedetails.php?k=<?php echo $this->_tpl_vars['v']['pkey']; ?>
...
<div ><a  onclick="log()" style="background-color: skyblue;color: white;text-align: center;width: 150px;padding: 10px;font-size: 20px;margin-bottom: 5px;margin-right: 15%;float: right;display: block;height: 45px;" href="latestpackages.php?v=news">View More</a></div>
...
<div style="height: 960px;background-image: url(web/images/palm-tree-sand-beach-sunny-day-beach.jpg);background-repeat: no-repeat;background-attachment: fixed;background-size: cover;">
 <div id="holi" class="container" style="height: 900px;">
        <div class="row justify-content-center mb-5">
          <div class="col-md-7 text-center">
            <span class="text-serif text-primary" style="font-size: 30px;">HOLIDAY PACKAGES</span>
            <!-- <h3 class="heading-92913 text-black text-center" style="font-size: 28px;">Our Destinations</h3> -->
          </div>
        </div>
        <div class="row">
...
<a onclick="log()" style="background-color: skyblue;color: white;text-align: center;width: 150px;padding: 10px;font-size: 20px;margin-bottom: 5px;margin-right: 15%;float: right;display: block;height: 45px;" href="holidaypackages.php">View More</a>
</div>
...
<div style="height: 960px;background-image: url(web/images/504c257321d5a7985baac8d4c74e7fcc.jpg);background-repeat: no-repeat;background-attachment: fixed;background-size: cover;">
 ...
 <div class="container" style="height: 900px;">
        <div class="row justify-content-center mb-5">
          <div class="col-md-7 text-center">
            <span class="text-serif text-primary" style="font-size: 30px;">ADVENTURE PACKAGES</span>
            <!-- <h3 class="heading-92913 text-black text-center" style="font-size: 28px;">Our Destinations</h3> -->
          </div>
        </div>
        <div class="row">
...
<div ><a onclick="log()" style="background-color: skyblue;color: white;text-align: center;width: 150px;padding: 10px;font-size: 20px;margin-bottom: 5px;margin-right: 15%;float: right;display: block;height: 45px;" href="adventurepackages.php">View More</a></div>
</div>
<!--  -->
...
<div style="height: 960px;background-image: url(web/images/sea-290025.jpg);background-repeat: no-repeat;background-attachment: fixed;background-size: cover;">
 <div class="container" style="height: 900px;">
        <div class="row justify-content-center mb-5">
          <div class="col-md-7 text-center">
            <span class="text-serif text-primary" style="font-size: 30px;">CRUISE PACKAGES</span>
            <!-- <h3 class="heading-92913 text-black text-center" style="font-size: 28px;">Our Destinations</h3> -->
          </div>
        </div>
        <div class="row">
...
<div ><a onclick="log()" style="background-color: skyblue;color: white;text-align: center;width: 150px;padding: 10px;font-size: 20px;margin-bottom: 5px;margin-right: 15%;float: right;display: block;height: 45px;" href="cruisepackages.php">View More</a></div>
</div>
<!--  -->
...
<div class="container" style="height: 900px;">
        <div class="row justify-content-center mb-5">
          <div class="col-md-7 text-center">
            <span class="text-serif text-primary" style="font-size: 30px;">FAMILY PACKAGES</span>
            <!-- <h3 class="heading-92913 text-black text-center" style="font-size: 28px;">Our Destinations</h3> -->
          </div>
        </div>
        <div class="row">
...
<div ><a onclick="log()" style="background-color: skyblue;color: white;text-align: center;width: 150px;padding: 10px;font-size: 20px;margin-bottom: 5px;margin-right: 15%;float: right;display: block;height: 45px;" href="familypackage.php">View More</a></div>
</div>
<!--  -->
...
<div style="height: 960px;background-image: url(web/images/774030.jpg);background-repeat: no-repeat;background-attachment: fixed;background-size: cover;">
 <div class="container" style="height: 900px;">
        <div class="row justify-content-center mb-5">
          <div class="col-md-7 text-center">
            <span class="text-serif text-primary" style="font-size: 30px;">LUXURY PACKAGES</span>
            <!-- <h3 class="heading-92913 text-black text-center" style="font-size: 28px;">Our Destinations</h3> -->
          </div>
        </div>
        <div class="row">
...
<div ><a onclick="log()" style="background-color: skyblue;color: white;text-align: center;width: 150px;padding: 10px;font-size: 20px;margin-bottom: 5px;margin-right: 15%;float: right;display: block;height: 45px;" href="luxarypackages.php">View More</a></div>
</div>
</table>
