<?php /* Smarty version 2.6.26, created on 2020-04-18 08:35:45
         compiled from useragencyfind.tpl */ ?>
<html>
  <head>
    <!--  -->
      ...
      <div class="container">
        <div class="row justify-content-center mb-5">
          <div class="col-md-7 text-center">
            <span class="text-serif text-primary" style="font-size: 60px;">Agency</span><br>
...
<br><a style="text-decoration: none;" href="packagedetails.php?k=<?php echo $this->_tpl_vars['v']['pkey']; ?>
"><i class="fa fa-phone" aria-hidden="true"></i> <?php echo $this->_tpl_vars['v']['ph']; ?>
