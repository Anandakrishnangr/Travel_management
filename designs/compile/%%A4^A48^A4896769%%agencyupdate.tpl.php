<?php /* Smarty version 2.6.26, created on 2020-10-14 15:26:51
         compiled from agencyupdate.tpl */ ?>
<!DOCTYPE html>
...
?>
			...
			<tr><td  colspan="4" style="text-align: center;"><div class="containerr"><img src="<?php echo $this->_tpl_vars['b']['pathpic']; ?>
"><br><label  style="text-align: center;" for="dp">Display Picture</label>
		...
		<tr><td>	<label for="username">Agency Name  </label>	</td><td><input type="text" name="aname" value="<?php echo $this->_tpl_vars['b']['aname']; ?>
" required></td>
			<td>	<label for="ph">Contact Number </label>			</td><td>	<input type="number" name="ph" value="<?php echo $this->_tpl_vars['b']['ph']; ?>
" required>					</td></tr>
		<tr><td>	<label for="district">District</label>		</td><td>
					<select 	id="dist" name="dist" placeholder="District"  required>	
					<option  >  <?php echo $this->_tpl_vars['b']['dist']; ?>
 	</option>								
				...
				<td>	<label for="district">Postal Code  </label>	</td><td>	<input type="number" name="pin" value="<?php echo $this->_tpl_vars['b']['pin']; ?>
" required>				</td></tr>
		
		<tr><td>	<label for="">Address</label></td>
				<td colspan="3">		<textarea class=".reg"  style="width: 100%;height: 130px;" type="text" id="" name="address" ><?php echo $this->_tpl_vars['b']['address']; ?>
</textarea></td></tr>
				
		<tr style="display: none;"><td>	<label for="district">Registeration Number  </label>	</td><td>	<input type="text" name="regno" value="<?php echo $this->_tpl_vars['b']['regno']; ?>
" required>				</td></tr>
...
<html>
    ...
    foreach ($_from as $this->_tpl_vars['b']):
?>
		<tr><td>	Agency Name  	</td><td>	<input type="text" name="aname" value="<?php echo $this->_tpl_vars['b']['aname']; ?>
">	</td></tr>
		<tr><td>	Address 		</td><td>	<textarea	   	   name="address" ><?php echo $this->_tpl_vars['b']['address']; ?>
</textarea>	</td></tr>
		<tr><td>	Pincode 		</td><td>	<input type="text" name="pin" value="<?php echo $this->_tpl_vars['b']['pin']; ?>
">		</td></tr>
		...
		<tr><td>	Contact Number 			</td><td>	<input type="text" name="ph" value="<?php echo $this->_tpl_vars['b']['ph']; ?>
">
							</td></tr>
		<tr><td>	Registeration Number  	</td><td>	<input type="text" name="regno" value="<?php echo $this->_tpl_vars['b']['regno']; ?>
">				</td></tr>
