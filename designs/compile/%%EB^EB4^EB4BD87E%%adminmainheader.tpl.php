<?php /* Smarty version 2.6.26, created on 2020-11-12 15:38:42
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li><a href="bloggridview.php">Blogs</a></li>
            ...
            <li><a href="adminfeedbackview.php">Feedbacks</a></li>
            <li class="menu-has-children"><a href="#">Inventory</a>
          <ul>
            <li><a href="adminnotificationsend.php">Send Notification</a></li>
              <li><a href="blogadminaproval.php">Blog Approve</a></li>
          <li><a href="agencyadminaproval.php">Agency Approve</a></li>
                      <li><a href="adminusermanage.php">Manage user</a></li>
<li class="menu-has-children"><a href="#">Complaints</a>
                <ul>
                  <li><a href="adminusercomplaintview.php">User Complaints</a></li>
                <li><a href="adminagencycomplaintview.php">Agency Complaints</a></li>
                 
                </ul>
          </li>
           </ul>
           <li><a href="rev.php">Revenue</a></li>
         </li>
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-7 ml-auto text-right" data-aos="fade-up">
              ...
              <p>Discover the world with Imperials-LIVE TO TRAVEL.</p>
              <a style="background-color: black;color: white;font-size: 20px;width: 100px;height: 50px;border-radius: 15px;display: block;text-align: center;padding: 10px;float: right;" href="changetile.php?k=1">Change</a>
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-7 mx-auto text-center" data-aos="fade-up">
              <h1>IMPERIAL-LIVE TO TRAVEL</h1>
              <p>.</p>
              <a style="background-color: black;color: white;font-size: 20px;width: 100px;height: 50px;border-radius: 15px;display: block;text-align: center;padding: 10px;float: right;" href="changetile.php?k=2">Change</a>
