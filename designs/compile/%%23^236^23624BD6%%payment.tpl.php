<?php /* Smarty version 2.6.26, created on 2020-09-20 16:56:27
...
<body>
	<div class="main">
												...
												<div class="transaction">
													<div class="tab-form-left user-form">
														<h5>EXPIRATION</h5>
															<ul>
																<li>
																	<input type="number" class="text_box" type="text" value="6" min="1" name="emonth" required/>	
																</li>
																<li>
																	<input type="number" class="text_box" type="text" value="2020" min="1" name="eyear" required/>	
																</li>
		...
		<p class="footer">Copyright © 2020 Payment . All Rights Reserved | Template by A</p>
	</div>
</body>
</html>