<?php /* Smarty version 2.6.26, created on 2020-09-20 16:27:03
         compiled from publicsubheader.tpl */ ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="container">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li><a href="index.php#features3-c">Blogs</a></li>
          <li><a href="index.php#holi">Holiday Packages</a></li>
