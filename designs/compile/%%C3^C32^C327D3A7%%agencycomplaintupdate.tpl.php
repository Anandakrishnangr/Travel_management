<?php /* Smarty version 2.6.26, created on 2020-11-12 06:39:19
         compiled from agencycomplaintupdate.tpl */ ?>
<!DOCTYPE html>
<html>
<head>
...
?>
		...
		<tr  style="font-family: Georgia,serif; font-size: 15px;"><td style="padding: 10px;">Subject</td><td style="padding: 10px;"><input  style="width: 100%;" type="text" name=" subject" value="<?php echo $this->_tpl_vars['u']['subject']; ?>
"></td></tr>
