<?php /* Smarty version 2.6.26, created on 2020-01-24 12:56:22
  ...
  <div class="site-wrap">
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-6 col-lg-3">
            <a href="index.html">
              <img src="web/images/logo.png" alt="Image" class="img-fluid">
          ...
          <div class="mx-auto">
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none pl-0 d-lg-block">
                ...
                <li>
                  <a href="aaa.php" class="nav-link text-left">About Us</a>
                </li>
                <li>
                  <a href="aaa.php" class="nav-link text-left">Services</a>
                </li>
                <li>
                    <a href="aaa.php" class="nav-link text-left">Testimonials</a>
                </li>
                <li><a href="aaa.php" class="nav-link text-left">Blog</a></li>
                <li>
                    <a href="userreg.php" class="nav-link text-left">Signup</a>
                  </li>
              </ul>                                                                                                                                                                                                                                                                                          </ul>
            </nav>
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-7 ml-auto text-right" data-aos="fade-up">
              ...
              <p><a href="aaa.php" class="btn btn-primary py-3 px-5">Read More</a></p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="web/images/hero_2.jpg" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-6">
            ...
            <p><a href="aaa.php" class="btn btn-primary py-3 px-4">Learn More</a></p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="site-section bg-image overlay" style="background-image: url('web/images/hero_1.jpg');">
      <div class="container">
        <div class="row">
          <div class="col">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 mb-4">
            <div class="service-39381">
              <img src="web/images/hero_1.jpg" alt="Image" class="img-fluid">
              <div class="p-4">
                <h3><a href="aaa.php"><span class="icon-room mr-1 text-primary"></span> Croatia &mdash; Columbia</a></h3>
                <div class="d-flex">
                  <div class="mr-auto">
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-7">
            <p><img src="web/images/hero_1.jpg" alt="Image" class="img-fluid"></p>
          </div>
          <div class="col-md-5">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6 mb-lg-0">
            <div class="person">
              <figure>
                <img src="web/images/person_1.jpg" alt="Image" class="img-fluid">
                <div class="social">
                  <a href="aaa.php"><span class="icon-facebook"></span></a>
                  <a href="aaa.php"><span class="icon-twitter"></span></a>
                  <a href="aaa.php"><span class="icon-linkedin"></span></a>
                </div>
              </figure>
          ...
          <div class="col-lg-3 col-md-6 mb-lg-0">
            <div class="person">
              <figure>
                <img src="web/images/person_2.jpg" alt="Image" class="img-fluid">
                <div class="social">
                  <a href="aaa.php"><span class="icon-facebook"></span></a>
                  <a href="aaa.php"><span class="icon-twitter"></span></a>
                  <a href="aaa.php"><span class="icon-linkedin"></span></a>
          ...
          <div class="col-lg-3 col-md-6 mb-lg-0">
            <div class="person">
              <figure>
                <img src="web/images/person_3.jpg" alt="Image" class="img-fluid">
                <div class="social">
                  <a href="aaa.php"><span class="icon-facebook"></span></a>
                  <a href="aaa.php"><span class="icon-twitter"></span></a>
                  <a href="aaa.php"><span class="icon-linkedin"></span></a>
          ...
          <div class="col-lg-3 col-md-6 mb-lg-0">
            <div class="person">
              <figure>
                <img src="web/images/person_4.jpg" alt="Image" class="img-fluid">
                <div class="social">
                  <a href="aaa.php"><span class="icon-facebook"></span></a>
                  <a href="aaa.php"><span class="icon-twitter"></span></a>
                  <a href="aaa.php"><span class="icon-linkedin"></span></a>
        ...
        <div class="row">
          <div class="mb-4 mb-lg-0 col-md-6 col-lg-4">
            <div class="testimony-39291">
              ...
              <div class="d-flex vcard align-items-center">
                <div class="pic mr-3">
                  <img src="web/images/person_3_sq.jpg" alt="Image" class="img-fluid">
                </div>
                <div class="text">
          ...
          <div class="mb-4 mb-lg-0 col-md-6 col-lg-4">
            <div class="testimony-39291">
              ...
              <div class="d-flex vcard align-items-center">
                <div class="pic mr-3">
                  <img src="web/images/person_4_sq.jpg" alt="Image" class="img-fluid">
                </div>
                <div class="text">
                  <strong class="d-block">John Doe</strong>
                  <span>CEO and Co-Founder</span>
    ...
    <div class="site-section bg-image overlay" style="background-image: url('web/images/hero_2.jpg');">
      <div class="container">
    ...
    <div class="footer bg-light">
      <div class="container">
        <div class="row">
          <div class="col-lg-3">
            <p class="mb-4"><img src="web/images/logo.png" alt="Image" class="img-fluid"></p>
          ...
          <div class="col-lg-3">
            ...
            <ul class="list-unstyled">
                <li><a href="aaa.php">About</a></li>
                <li><a href="aaa.php">News</a></li>
                <li><a href="aaa.php">Services</a></li>
                <li><a href="aaa.php">Our Team</a></li>
                <li><a href="aaa.php">Careers</a></li>
                <li><a href="aaa.php">Projects</a></li>
            </ul>
          </div>
          <div class="col-lg-3">
              <h3 class="footer-heading"><span>Our Services</span></h3>
              <ul class="list-unstyled">
                  <li><a href="aaa.php">Industrial</a></li>
                  <li><a href="aaa.php">Construction</a></li>
                  <li><a href="aaa.php">Remodeling</a></li>
              </ul>
          </div>
          <div class="col-lg-3">
              <h3 class="footer-heading"><span>Contact</span></h3>
              <ul class="list-unstyled">
                  <li><a href="aaa.php">Help Center</a></li>
                  <li><a href="aaa.php">Support Community</a></li>
                  <li><a href="aaa.php">Press</a></li>
                  <li><a href="aaa.php">FAQ</a></li>
                  <li><a href="aaa.php">Our Partners</a></li>
              </ul>
          </div>
        </div>
          ...
          <div class="col-12">
            <div class="copyright">
                <p>
                    ...
                    Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="icon-heart text-danger" aria-hidden="true"></i> by <a href="aaa.php" target="_blank" >Colorlib</a>
                    <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                    </p>
            </div>
          </div>
