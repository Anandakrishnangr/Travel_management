<?php /* Smarty version 2.6.26, created on 2020-11-01 14:24:21
         compiled from chatdem.tpl */ ?>
<html>
<head>
...
<?php $_from = $this->_tpl_vars['viewes']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['vv']):
?>
              <div class="chat_people">
                <div class="chat_img"> <img src="<?php echo $this->_tpl_vars['vv']['pathpic']; ?>
" style="border-radius: 20px;height: 43px;width: 43px;" alt="sunil"> </div>
                <div class="chat_ib">
                  <h5  style="text-transform: capitalize;"><?php echo $this->_tpl_vars['vv']['aname']; ?>
<?php echo $this->_tpl_vars['vv']['username']; ?>
<span class="chat_date"><?php echo $this->_tpl_vars['vv']['time']; ?>
</span></h5>
                  <p><?php echo $this->_tpl_vars['vv']['chat']; ?>
</p>
                </div>
              </div>
...
?>
            ...
            <?php if ($this->_tpl_vars['v']['v'] == 1 && $this->_tpl_vars['v']['receiverid'] != $this->_tpl_vars['v']['loginid']): ?>
...
</p>1<?php $_from = $this->_tpl_vars['oss']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['os']):
?>
               <?php if ($this->_tpl_vars['v']['receiverid'] == $this->_tpl_vars['os']['id']): ?><?php if ($this->_tpl_vars['os']['onlinestatus'] == 1): ?>
...
<span class="chat_date"><?php echo $this->_tpl_vars['v']['time']; ?>
                  ...
                  <p style="overflow: hidden;"><?php echo $this->_tpl_vars['v']['chat']; ?>
</p>2<?php $_from = $this->_tpl_vars['oss']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['os']):
?>
               <?php if ($this->_tpl_vars['v']['senderid'] == $this->_tpl_vars['os']['id']): ?><?php if ($this->_tpl_vars['os']['onlinestatus'] == 1): ?>  <svg xmlns="http://www.w3.org/2000/svg">
    <circle cx="5" cy="5" r="5" fill="green" />
</svg>
             <?php else: ?>
<svg xmlns="http://www.w3.org/2000/svg">
...
<?php $_from = $this->_tpl_vars['qw']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['v']):
?>
<?php if ($this->_tpl_vars['vv']['loginid'] != $this->_tpl_vars['v']['loginid']): ?>
<a href="demonchat.php?g=<?php echo $this->_tpl_vars['v']['loginid']; ?>
">
            <div class="chat_list">
             <div class="chat_people">
...
<div id="result-wrapper"  style="height: 516px;display: block;">
  <div id="result" style="height: 516px;">
    
      <?php require_once(SMARTY_CORE_DIR . 'core.smarty_include_php.php');
smarty_core_smarty_include_php(array('smarty_file' => 'load.php', 'smarty_assign' => '', 'smarty_once' => false, 'smarty_include_vars' => array()), $this); ?>
...
<form method=\'post\' action="#" onsubmit="return post();" id="my_form" name="my_form" style="display: block;">

  '; ?>

<div id="form-container" style=" border:1px solid;border-color: #87ceeb;height: 60px;">
  
      <input type="text" style="display: none;" id="re" value="<?php echo $this->_tpl_vars['o']; ?>
">
      <?php echo '
      <textarea id="name"  autocomplete="off" type="text" class="write_msg" name="name" style="resize: none;box-shadow: none; outline: none;border: none;width: 550px;text-align: left;margin-left: 3px;height: 50px;margin-top: 5px;margin-left: 5px;" placeholder="Type message here" required ></textarea>

    <a style="float: right;margin-top: 5px;margin-right: 5px;"  onclick="document.getElementById(\'btn\').click()"><img src="web/ak/icon/msg.png" style="width: 45px;height: 40px;background-repeat: no-repeat;margin-top: 4px;margin-right: 2px;"></a>



    <div class="form-btn">
      <input style="float: right;display: none;max-width: 100px;max-height: 60px;" type="submit" value="Send" id="btn" name="btn"/>
    </div>
</div>
</form>
          </div>  </div>
