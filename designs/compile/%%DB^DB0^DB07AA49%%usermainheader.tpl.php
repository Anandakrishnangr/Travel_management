<?php /* Smarty version 2.6.26, created on 2020-11-13 17:59:29
...
<head>
  <meta charset="utf-8">
  <title>Welcome <?php echo $this->_tpl_vars['s']['username']; ?>
</title>
...
-->
         ...
         <li><a href="userbookingview.php"><i class="fa fa-shopping-cart fa-2x" aria-hidden="true" style="float: left;"></i>&nbsp; Cart</a></li>
          ...
          <li class="menu-has-children"><a style="color: white;"><font style="font-style: bold;text-transform: capitalize;"><?php echo $this->_tpl_vars['s']['username']; ?>
</font></a>
            <ul>
