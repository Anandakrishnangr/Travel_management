<?php /* Smarty version 2.6.26, created on 2020-11-02 18:03:02
         compiled from publicmainheader.tpl */ ?>
<!DOCTYPE html>
<html lang="en">

<head>
  <meta charset="utf-8">
  <title>Imperial-LIVE TO TRAVEL</title>
...
<script type="text/javascript">
  function log() {
    alert(\'Login first to get access\');
  }
</script>
'; ?>
...
<body>
  ...
  <section id="hero">
    <div class="hero-container">
      <div class="wow fadeIn">
        ...
        <div class="actions">
          <a href="#her" class="btn-get-started">Get Strated</a>
  ...
  <header id="header">
    <div class="container">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li><a href="#features3-c">Blogs</a></li>
          <li><a href="#holi">Holiday Packages</a></li>
          <li><a href="login.php" onclick="alert('Login first');">Agencys</a></li>
         
          <li class="menu-has-children"><a style="color: white;">Account</a>
            <ul>
              <li><a href="login.php">Login</a></li>
              <li><a href="userreg.php">SignUp</a></li>
            <li><a href="areg.php">Register Agency</a></li>
    ...
    <div id="her" class="hero-slide owl-carousel site-blocks-cover">
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-7 mx-auto text-center" data-aos="fade-up">
              ...
              <p>Explore the oceans with your family.We have a large colection of packages for you.</p>
