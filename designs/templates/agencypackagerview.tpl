...
<center>
		...
		<tr><td>{$b.username}</td>
			<td>{$b.packagename}</td>
			<td><div style="pointer-events:none;"><input  id="kartik" name="rate" class="rating" data-stars="5" data-step="0.1" value="{$b.4}" title=""/>
        		<div  style="pointer-events:none;" class="form-group" style="margin-top:5px"></td>
        	<td><div style="pointer-events:none;"><input style="pointer-events:none;"  id="kartik" name="rate" class="rating" data-stars="5" data-step="0.1" value="{$b.arating}" title=""/>
