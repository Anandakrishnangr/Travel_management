	...
	<form action="" method="post">
		...
		<div class="akcontusedcard">
			...
			<div class="akpc"><table style="table-layout: fixed;">
				<tr><td><p class="aknamep" style="text-transform: capitalize;">Name		 :{$s.nameholder}	</p></td></tr>
				<tr><td><p class="aknamep">Card Number  :{$s.cardno}		</p></td><td><p>Expire  :XX/XXXX</p></td></tr>
				<tr><td><p class="aknamep">Added On :{$s.currentdate}	</p></td><td><p>CCV  :XXX</p></td></tr>
