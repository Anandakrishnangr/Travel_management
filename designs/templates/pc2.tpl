              ...
              <div class="p-4" >
                ...
                <div class="d-flex">
                  ...
                  <div class="ml-auto price">
                    <span class="bg-primary"><a onclick="log()" style="text-decoration: none;color: white;font-size: 12px;" href="packagedetails.php?k={$v.pkey}">${$v.packageamount}</a></span>
                  </div>
