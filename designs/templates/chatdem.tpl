...
{foreach from=$viewes item="vv"}
              <div class="chat_people">
                <div class="chat_img"> <img src="{$vv.pathpic}" style="border-radius: 20px;height: 43px;width: 43px;" alt="sunil"> </div>
                <div class="chat_ib">
                  <h5  style="text-transform: capitalize;">{$vv.aname}{$vv.username}<span class="chat_date">{$vv.time}</span></h5>
                  <p>{$vv.chat}</p>
                </div>
              </div>
{/foreach}
            ...
            {if $o!=$v.loginid}
            {if $v.v==1&&$v.receiverid!=$v.loginid}
            ...
            <div class="chat_list active_chat">
             <div class="chat_people">
                ...
                <div class="chat_ib">
                  ...
                  <p style="overflow: hidden;">{$v.chat}</p>1{foreach from=$oss item="os"}
               {if $v.receiverid==$os.id}{if $os.onlinestatus==1}
         ...
         <a href="demonchat.php?g={$v.loginid}">
            <div class="chat_list">
             <div class="chat_people">
                ...
                <div class="chat_ib">
                  <h5 style="text-transform: capitalize;">{$v.aname}{$v.username}<span class="chat_date">{$v.time}</span></h5>
                  <p style="overflow: hidden;">{$v.chat}</p>2{foreach from=$oss item="os"}
               {if $v.senderid==$os.id}{if $os.onlinestatus==1}  <svg xmlns="http://www.w3.org/2000/svg">
    <circle cx="5" cy="5" r="5" fill="green" />
</svg>
             {else}
<svg xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="chat_list">
             <div class="chat_people">
                ...
                <div class="chat_ib">
                  ...
                  <p style="text-transform: capitalize;">Say hi to {$v.aname}{$v.username}  !</p>{foreach from=$oss item="os"}
...
<div id="form-container" style=" border:1px solid;border-color: #87ceeb;height: 60px;">
      ...
      <input type="text" style="display: none;" id="re" value="{$o}">
      {literal}
