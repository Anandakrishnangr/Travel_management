...
{if $vv1.0==$x1.0}{$x1.1}{/if}
                    ...
                    <div class="mbr-section-btn text-center"><a  onclick="log()" href="blogview.php?k={$vv1.blogkey}" class="btn btn-primary-outline display-4">
                            Read More
                        </a></div>
                </div>
            </div>
...
{if $vv.0==$x1.0}{$x1.1}{/if}
                    ...
                    <div class="mbr-section-btn text-center"><a onclick="log()" href="blogview.php?k={$vv.blogkey}" class="btn btn-primary-outline display-4">
                            Read More
                        </a></div>
                </div>
              </div>{/foreach}
