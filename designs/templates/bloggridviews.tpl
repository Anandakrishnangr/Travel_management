        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 mb-5 mb-lg-5 col-lg-4" >
                    ...
                    <u class="fa fa-heart fa-2x" ></u>{$b.likes}
...
{if $b.0==$x1.0}{$x1.1}{/if}
                    ...
                    <div class="blog-entry-contents">
                        ...
                        <div class="meta"  style="font-size: 18px;">Posted by <a  style="text-transform: capitalize;">{$b.username}</a><!-- In <a href="">News</a>--></div>
                    </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 mb-5 mb-lg-5 col-lg-4">
                    ...
                    <div  style="margin-top: -35px;">
                      <u class="fa fa-heart fa-2x" ></u>{$c.likes}
...
{if $c.0==$x1.0}{$x1.1}{/if}
                    ...
                    <div class="blog-entry-contents">
                        ...
                        <div class="meta" style="font-size: 16px;">Posted by <a  style="text-transform: capitalize;">{$c.aname}</a><!-- In <a href="">News</a>--></div>
                    </div>
                    </div>
                </div>
...
<div style="background-color: skyblue;color: white;text-align: left;width: 70%;padding: 5px;font-size: 20px;padding-left: 10px;margin-bottom: 10px;">NEWS</div></center>   <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 mb-5 mb-lg-5 col-lg-4">
                    <div class="blog-entry" style="background-color: #ffffff;padding: 5px;">
                    <a href="blogview.php?k={$vv1.blogkey}" class="img-link">
                        <img src="{$vv1.pathpic}" style="height: 212px;width: 100%;" alt="Image" class="img-fluid">
                    </a>

                    <div  style="margin-top: -35px;">
                      <u class="fa fa-heart fa-2x" ></u>{$vv1.likes}
...
{if $vv1.0==$x1.0}{$x1.1}{/if}
                    ...
                    <div class="blog-entry-contents">
                        <h3 style="min-height: 64px;"><a   href="blogview.php?k={$vv1.blogkey}">{$vv1.head}</a></h3>
                        <div class="meta" style="font-size: 16px;">Posted by <a  style="text-transform: capitalize;">{$vv1.aname}</a><!-- In <a href="">News</a>--></div>
                    </div>
                    </div>
                </div>
...
{if $vv1.0==$x1.0}{$x1.1}{/if}
                    ...
                    <div class="blog-entry-contents">
                        <h3 style="min-height: 64px;"><a   href="blogview.php?k={$vv1.blogkey}">{$vv1.head}</a></h3>
                        <div class="meta" style="font-size: 16px;">Posted by <a  style="text-transform: capitalize;">{$vv1.aname}{$vv1.username}</a><!-- In <a href="">News</a>--></div>
                    </div>
                    </div>
                </div>
...
{if $vv1.0==$x1.0}{$x1.1}{/if}
                    ...
                    <div class="blog-entry-contents">
                        <h3 style="min-height: 64px;"><a   href="blogview.php?k={$vv1.blogkey}">{$c.head}</a></h3>
                        <div class="meta" style="font-size: 16px;">Posted by <a  style="text-transform: capitalize;">{$vv1.aname}{$vv1.username}</a><!-- In <a href="">News</a>--></div>
                    </div>
                    </div>
                </div>
