...
<a href="notadd.php?k={$b.loginid}">
<div class="noty"><img  class="akproimg" src="{$b.pathpic}" alt="No DP"><div class="akname">{$b.username}</div></div>
</a>
...
<a href="notadd.php?k={$bb.loginid}">
<div class="noty"><img  class="akproimg" src="{$bb.pathpic}" alt="No DP"><div class="akname">{$bb.aname}</div></div>
</a>
